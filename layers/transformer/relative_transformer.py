...
from .multi_head_relative_pos_attention import (
    FixedRelativeMultiheadAttention,
    AttentionMask,
)
...
class RelativeTransformer(Transformer):
    def __init__(
        ...
        super().__init__(
            ...
            encoder_layer=TransformerEncoderWithLayer(RelativeTransformerEncoderLayer),
            decoder_layer=TransformerDecoderWithLayer(RelativeTransformerDecoderLayer),
        )
